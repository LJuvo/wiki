<template>
  <div id="svgContainer7" style="width:100%;height:600px"></div>
</template>
<script>
...
export default {
  ...
  mounted() {
    ...
    const containerWidth = document.getElementById("svgContainer7").offsetWidth;
    const containerHeight = document.getElementById("svgContainer7")
      .offsetHeight;
    var svg = d3
      .select("#svgContainer7")
      .append("svg")
