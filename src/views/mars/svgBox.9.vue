<template>
  <div id="svgContainer9" style="width:100%;height:600px"></div>
</template>
<script>
...
export default {
  ...
  mounted() {
    ...
    const containerWidth = document.getElementById("svgContainer9").offsetWidth;
    const containerHeight = document.getElementById("svgContainer9")
      .offsetHeight;
    var svg = d3
      .select("#svgContainer9")
      .append("svg")
